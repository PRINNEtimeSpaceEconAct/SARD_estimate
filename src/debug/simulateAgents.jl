...
############## PDE #############################################################
tau = 1.5
# SARDp = (gammaS = 0.0, gammaA = -0.1, gammaR = 0.0, gammaD = 0.0, hA = 0.4, hR = 0.3)
SARDp = (gammaS = 0.0, gammaA = 0.0, gammaR = 0.1, gammaD = 0.0, hA = 0.3, hR = 0.3)
...
function make_u0(Δx,Whu0)
    σ = 0.05
    XNorm = MvNormal([0.5-Δx/2,0.5-Δx/2],σ*I(2))
    Nx = Int(1/Δx)
    x = 0.0:Δx:(1-Δx)
    y = 0.0:Δx:(1-Δx)
    u0 = [pdf(XNorm,[xi,yi]) for xi in x, yi in y]
